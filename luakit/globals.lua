...
globals = {
    homepage            = "file:///home/schleumer/.config/luakit/search.html",
...
search_engines = {
    ...
    correios    = "http://websro.correios.com.br/sro_bin/txect01$.QueryList?P_LINGUA=001&P_TIPO=001&P_COD_UNI=%s"
}
